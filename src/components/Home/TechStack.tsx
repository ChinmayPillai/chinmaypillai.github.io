...
export default function TechStack(){
    ...
    return(
        <div>
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Programming Languages:</Typography>
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>AI/ML:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Backend Development:</Typography>
            <p style={{textAlign:"left"}}> 
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Frontend Development:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Database:</Typography>
            <p style={{textAlign:"left"}}> 
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>DevOps:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>OS:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>CI/CD:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Frameworks:</Typography>
            <p style={{textAlign:"left"}}>  
            ...
            <Typography variant="h4" color={textColour} style={{textAlign:"left"}}>Other Software:</Typography>
            <p style={{textAlign:"left"}}> 
