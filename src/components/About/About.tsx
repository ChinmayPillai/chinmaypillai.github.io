...
function About() {
  return (
    <Container sx={{ mb: 8, mt: 5, minHeight: "100vh" }}>
      ...
      />
      <Reveal>
        <Typography variant="h2" component="h1" align="center" sx={{ mb: 5 }}>
          About Me
        </Typography>
      </Reveal>
      <Stack spacing={4} divider={<Divider sx={{ borderColor: "border.subtle" }} />}>
        {sections.map((section) => (
          <Stack key={section.heading} spacing={2}>
            <Reveal>
              <Typography variant="h4" component="h2" color="text.heading">
                {section.heading}
              </Typography>
            </Reveal>
